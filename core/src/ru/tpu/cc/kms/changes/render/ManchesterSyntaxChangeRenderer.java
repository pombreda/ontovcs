...
public class ManchesterSyntaxChangeRenderer extends ChangeRenderer {
	...
	public ManchesterSyntaxChangeRenderer() {
		super();
	}

	public ManchesterSyntaxChangeRenderer(boolean oneLine) {
		this();
	...
	public String getRendering(Change<Statement> change) {
		String s;
		try {
			s = new ManchesterSyntaxStatementRenderer().getRendering(change.getItem());
